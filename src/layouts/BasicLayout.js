...
const { Search } = Input;
const menuData = [
  { route: '/system1', name: '推荐' },
  { route: '/system2', name: '知识图谱' },
  { route: '/system3', name: '主题图谱' },
  { route: '/system4', name: '在线分析' },
  { route: '/system5', name: '排行榜' },
  { route: '/system6', name: '造句分析' },
  { route: '/system7', name: '智能问答' },
  { route: '/system8', name: '我的收藏' },
  { route: '/system9', name: '我的评论' },
  { route: '/system0', name: '词汇管理' },
];
const msgNum = 0;
  ...
  return (
    <Layout className={styles.layoutHeader}>
      <Header className={styles.basicLayoutHeader} theme="light">
        <div>
          <Menu mode="horizontal" className={styles.searchHead}>
            <Menu.Item style={{ margin: '0 5px', lineHeight: '30px' }}>
              关键词
            </Menu.Item>
            <Menu.Item style={{ margin: '0 5px', lineHeight: '30px' }}>
              主题图谱
